...
use App\Application\Commands\Participant\ChangeParticipantPasswordHandler;
...
use App\Application\Commands\Participant\RegisterParticipantHandler;
...
use App\Application\Commands\Participant\UpdateParticipantProfileHandler;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $commandBus->register(RegisterParticipantCommand::class, RegisterParticipantHandler::class);
        $commandBus->register(UpdateParticipantProfileCommand::class, UpdateParticipantProfileHandler::class);
        $commandBus->register(ChangeParticipantPasswordCommand::class, ChangeParticipantPasswordHandler::class);
