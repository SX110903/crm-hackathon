...
class ParticipantTest extends TestCase
{
    ...
    public function can_create_a_participant(): void
    {
        ...
        $this->assertDatabaseHas('participants', ['email_hash' => hash('sha256', 'jane@example.com')]);
    }

    /** @test */
    public function create_fails_with_missing_required_fields(): void
    {
        // Se omiten todos los campos requeridos; se espera error de validación 422
        $this->actingAs($this->admin, 'sanctum')
